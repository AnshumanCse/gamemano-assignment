...
const GameHighlight = () => {
  const words = ["Magic", "Valorant", "Evolution"];

  return (
    <section className="relative border-l border-gray-500 bg-gradient-to-r from-black to-[#342e24] text-white py-10 pr-4 pl-[300px]">
      {/* Top Right Status */}
  ...
  <span className="text-green-300">40 of your friends are playing</span>
      ...
      <div className="text-white max-w-2xl space-y-6 px-2 sm:px-4">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-normal font-[family-name:var(--font-wallpoet)] text-white">
